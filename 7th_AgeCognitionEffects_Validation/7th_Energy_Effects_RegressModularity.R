...
# Import modularity Q
Modularity_Q_Mat <- readMat(paste0(ReplicationFolder, '/data/Modularity_Yeo_Q_FA.mat'));
...
Modularity_Q_Cognition <- Modularity_Q[NonNANIndex];
...
Energy_Gam <- gam(tmp_variable ~ s(Age_years, k=4) + nbackBehAllDprime + Modularity_Q_Cognition + Sex_factor + HandednessV2 + MotionMeanRelRMS + TBV + Strength_EigNorm_SubIden_Cognition, method = "REML", data = Behavior_New);
...
tmp_variable <- Energy_YeoAvg_Cognition[, 8];
Energy_Gam <- gam(tmp_variable ~ s(Age_years, k=4) + F1_Exec_Comp_Res_Accuracy + Modularity_Q_Cognition + Sex_factor + HandednessV2 + MotionMeanRelRMS + TBV + Strength_EigNorm_SubIden_Cognition, method = "REML", data = Behavior_New);
...
tmp_variable <- Energy_YeoAvg_Cognition[, 8];
Energy_Gam <- gam(tmp_variable ~ s(Age_years, k=4) + F2_Social_Cog_Accuracy + Modularity_Q_Cognition + Sex_factor + HandednessV2 + MotionMeanRelRMS + TBV + Strength_EigNorm_SubIden_Cognition, method = "REML", data = Behavior_New);
...
tmp_variable <- Energy_YeoAvg_Cognition[, 8];
Energy_Gam <- gam(tmp_variable ~ s(Age_years, k=4) + F3_Memory_Accuracy + Modularity_Q_Cognition + Sex_factor + HandednessV2 + MotionMeanRelRMS + TBV + Strength_EigNorm_SubIden_Cognition, method = "REML", data = Behavior_New);
