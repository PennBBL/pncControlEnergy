...
Energy_Gam <- gam(tmp_variable ~ s(Age_years, k=4) + nbackBehAllDprime + AvgControl_Yeo_Cognition[,8] + Sex_factor + HandednessV2 + MotionMeanRelRMS + TBV + Strength_EigNorm_SubIden_Cognition, method = "REML", data = Behavior_New);
...
print('###### Excutive performance effect of average energy in subcortical system ######');
Energy_Subcortical_YeoAvg_Cognition <- Energy_YeoAvg_Cognition[, 8];
Energy_Gam <- gam(Energy_Subcortical_YeoAvg_Cognition ~ s(Age_years, k=4) + F1_Exec_Comp_Res_Accuracy + AvgControl_Yeo_Cognition[,8] + Sex_factor + HandednessV2 + MotionMeanRelRMS + TBV + Strength_EigNorm_SubIden_Cognition, method = "REML", data = Behavior_New);
...
print('###### Social cognition effect of average energy in subcortical system ######');
Energy_Gam <- gam(Energy_Subcortical_YeoAvg_Cognition ~ s(Age_years, k=4) + F2_Social_Cog_Accuracy + AvgControl_Yeo_Cognition[,8] + Sex_factor + HandednessV2 + MotionMeanRelRMS + TBV + Strength_EigNorm_SubIden_Cognition, method = "REML", data = Behavior_New);
...
print('###### Memory effect of average energy in subcortical system ######');
Energy_Gam <- gam(Energy_Subcortical_YeoAvg_Cognition ~ s(Age_years, k=4) + F3_Memory_Accuracy + AvgControl_Yeo_Cognition[,8] + Sex_factor + HandednessV2 + MotionMeanRelRMS + TBV + Strength_EigNorm_SubIden_Cognition, method = "REML", data = Behavior_New);
