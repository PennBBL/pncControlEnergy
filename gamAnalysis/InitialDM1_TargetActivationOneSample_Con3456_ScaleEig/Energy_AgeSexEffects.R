...
Energy_Mat_Path <- paste(Energy_Data_Folder, '/SC_Energy/SC_IniDM1_TarActiOneSampSig_Con3456_ScaleEig.mat', sep = '/');
...
ConIndex <- which(Energy[1,] != 0);
WholeBrainAvg <- rowMeans(Energy[,ConIndex]);
...
ResultantFolder <- '/data/joy/BBL/projects/pncControlEnergy/results/Development_Effects/YeoSystemLevel';
