...
ResultantFolder <- '/data/joy/BBL/projects/pncControlEnergy/results/InitialDM1_TargetActivation/Cognition_Effects/NodalLevel';
...
ResultantFolder <- '/data/joy/BBL/projects/pncControlEnergy/results/InitialDM1_TargetActivation/Cognition_Effects/YeoSystemLevel';
