...
Energy_Mat_Path <- paste(Energy_Data_Folder, '/SC_Energy/SC_InitialDM1_TargetIndivActi_Con3456_ScaleEig.mat', sep = '/');
Energy_Mat = readMat(Energy_Mat_Path);
Energy <- Energy_Mat$Energy;
Energy_YeoAvg <- Energy_Mat$Energy.YeoAvg;

Behavior <- readMat('/data/jux/BBL/projects/pncControlEnergy/data/subjectData/n677_Demogra_DtiMotion.mat');
...
Tissue <- readMat('/data/jux/BBL/projects/pncControlEnergy/data/subjectData/n677_ctVol20170412.mat');
Behavior$TBV <- as.numeric(Tissue$TBV);

Cognition <- readMat('/data/jux/BBL/projects/pncControlEnergy/data/subjectData/n677_cnb_factor_scores_tymoore_20151006.mat');
