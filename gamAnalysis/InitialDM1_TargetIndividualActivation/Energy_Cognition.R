...
Energy_Mat_Path <- paste(Energy_Data_Folder, '/SC_Energy/SC_InitialDM1_TargetIndividualActivation.mat', sep = '/');
Energy_Mat = readMat(Energy_Mat_Path);
Energy <- Energy_Mat$Energy;
Energy_YeoAvg <- Energy_Mat$Energy.YeoAvg;

Behavior <- readMat('/Users/zaixucui/Documents/projects/pncControlEnergy/data/subjectData/n677_Demogra_DtiMotion.mat');
...
Tissue <- readMat('/Users/zaixucui/Documents/projects/pncControlEnergy/data/subjectData/n677_ctVol20170412.mat');
Behavior$TBV <- as.numeric(Tissue$TBV);

Cognition <- readMat('/Users/zaixucui/Documents/projects/pncControlEnergy/data/subjectData/n677_cnb_factor_scores_tymoore_20151006.mat');
...
ResultantFolder <- '/Users/zaixucui/Documents/projects/pncControlEnergy/results/InitialDM1_TargetIndividualActivation/Cognition_Effects/NodalLevel';
...
ResultantFolder <- '/Users/zaixucui/Documents/projects/pncControlEnergy/results/InitialDM1_TargetIndividualActivation/Cognition_Effects/YeoSystemLevel';
