...
Energy_Mat = load([Energy_Folder '/SC_InitialDM1_TargetActivationOneSampleSig.mat']);
...
ResultantFolder = '/data/jux/BBL/projects/pncControlEnergy/results/InitialDM1_TargetActivationOneSampleSig/Energy_Activation_Relationship';
