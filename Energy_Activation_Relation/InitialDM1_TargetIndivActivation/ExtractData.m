...
Energy_Mat = load([Energy_Folder '/SC_InitialDM1_TargetIndividualActivation.mat']);
...
ResultantFolder = '/data/jux/BBL/projects/pncControlEnergy/results/InitialDM1_TargetIndiviActivation/Energy_Activation_Relationship';
