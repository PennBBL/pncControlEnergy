...
Energy_Mat = load([Energy_Folder '/SC_InitialDM1_TargetActivation_Scale1000.mat']);
...
ResultantFolder = '/data/jux/BBL/projects/pncControlEnergy/results/InitialDM1_TargetActivation_Scale1000/Energy_Activation_Relationship';
