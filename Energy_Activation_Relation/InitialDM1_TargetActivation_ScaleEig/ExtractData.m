...
Energy_Mat = load([Energy_Folder '/SC_InitialDM1_TargetActivation_ScaleEig.mat']);
...
ResultantFolder = '/data/jux/BBL/projects/pncControlEnergy/results/InitialDM1_TargetActivation_ScaleEig/Energy_Activation_Relationship';
