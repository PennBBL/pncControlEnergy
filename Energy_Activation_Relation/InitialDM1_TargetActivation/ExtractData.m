...
Energy_Mat = load([Energy_Folder '/SC_InitialDM1_TargetActivation.mat']);
...
Scan_ID_SC = Activation_Mat.Scan_ID_SC;
ResultantFolder = '/data/jux/BBL/projects/pncControlEnergy/results/InitialDM1_TargetActivation/Energy_Activation_Relationship';
save([ResultantFolder '/Energy_Activation.mat'], 'Activation', 'Energy_New', 'Activation_abs', 'Energy_New_log2', 'Activation_zscore', 'Energy_New_zscore', 'Activation_abs_zscore', 'Energy_New_log2_zscore', 'Scan_ID_SC');
