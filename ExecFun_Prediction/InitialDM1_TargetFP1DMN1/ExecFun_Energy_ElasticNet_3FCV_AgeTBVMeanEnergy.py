...
AgeTBVMeanEnergy_Mat = sio.loadmat(DataFolder + '/AgeTBVMeanEnergy.mat');
AgeTBVMeanEnergy = AgeTBVMeanEnergy_Mat['AgeTBVMeanEnergy'];

Behavior_Mat = sio.loadmat(DataFolder + '/Behavior.mat');
OverallAccuracy = Behavior_Mat['OverallAccuracy'];

ResultantFolder = '/data/joy/BBL/projects/pncControlEnergy/results/ExecFun_Prediction/Ridge_3FCV_AgeTBVMeanEnergy';
