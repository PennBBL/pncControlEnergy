...
ResultantFolder = '/data/joy/BBL/projects/pncControlEnergy/results/ExecFun_Prediction/Ridge_Weight';
Ridge_CZ_Sort_Energy.Ridge_Weight(Energy, OverallAccuracy, np.exp2(np.arange(16) - 10), 3, ResultantFolder, 5);
