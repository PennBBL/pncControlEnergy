...
AgeTBV_Mat = sio.loadmat(DataFolder + '/AgeTBV.mat');
AgeTBV = AgeTBV_Mat['AgeTBV'];

Behavior_Mat = sio.loadmat(DataFolder + '/Behavior.mat');
OverallAccuracy = Behavior_Mat['OverallAccuracy'];

ResultantFolder = '/data/joy/BBL/projects/pncControlEnergy/results/ExecFun_Prediction/Ridge_3FCV_AgeTBV';
Ridge_CZ_Sort_Energy.Ridge_KFold_Sort(AgeTBV, OverallAccuracy, 3, np.exp2(np.arange(16) - 10), ResultantFolder, 5, 0);
