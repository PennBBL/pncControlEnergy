...
Ridge_3FCV_Folder <- '/data/joy/BBL/projects/pncControlEnergy/results/ExecFun_Prediction/Ridge_3FCV';
...
cor.test(Fold_0_Mat$Predict.Score, t(Motion[Fold_0_Index]))
cor.test(Fold_1_Mat$Predict.Score, t(Motion[Fold_1_Index]))
cor.test(Fold_2_Mat$Predict.Score, t(Motion[Fold_2_Index]))
# TBV
...
cor.test(Fold_0_Mat$Predict.Score, t(TBV[Fold_0_Index]))
cor.test(Fold_1_Mat$Predict.Score, t(TBV[Fold_1_Index]))
cor.test(Fold_2_Mat$Predict.Score, t(TBV[Fold_2_Index]))
...
cor.test(Fold_0_Mat$Predict.Score, t(Age_years[Fold_0_Index]))
cor.test(Fold_1_Mat$Predict.Score, t(Age_years[Fold_1_Index]))
cor.test(Fold_2_Mat$Predict.Score, t(Age_years[Fold_2_Index]))
