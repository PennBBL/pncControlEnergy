...
Strength_EigNorm_SubIden <- Behavior$Strength.EigNorm.SubIden[SampleIndex_All];
...
Fig <- visreg(Gam_Model, 'F1ExecCompResAccuracy_New', xlab = 'F1ExecCompResAccuracy', ylab = 'Prediction Error', line.par = list(col = "#000000"), gg = TRUE);
