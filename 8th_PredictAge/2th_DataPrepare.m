...
Data = load([PredictionDataFolder '/Energy.mat']);
% Sample 1
Energy_Sample1 = Data.Energy(Sample1_Index, :);
Age_Sample1 = double(Behavior.Age(Sample1_Index));
save([PredictionDataFolder '/Energy_Sample1.mat'], 'Energy_Sample1');
...
save([PredictionDataFolder '/Energy_Sample2.mat'], 'Energy_Sample2');
