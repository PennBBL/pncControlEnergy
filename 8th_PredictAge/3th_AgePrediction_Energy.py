...
########################################
ResultantFolder = ReplicationFolder + '/results/FA_Energy/Age_Prediction/Sample1_Predict_Sample2';
...
ResultantFolder = ReplicationFolder + '/results/FA_Energy/Age_Prediction/Sample1_Predict_Sample2_Permutation';
...
########################################
ResultantFolder = ReplicationFolder + '/results/FA_Energy/Age_Prediction/Sample2_Predict_Sample1';
...
ResultantFolder = ReplicationFolder + '/results/FA_Energy/Age_Prediction/Sample2_Predict_Sample1_Permutation';
