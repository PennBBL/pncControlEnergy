...
## Define subject list
scanid_list=$(cut -d',' -f2 < /data/joy/BBL/projects/pncControlEnergy/subjectLists/pncControlEnergy_n1089_subjectIDs.csv) 

SC_outdir=/data/joy/BBL/projects/pncControlEnergy/data/matrices/Lausanne125/streamlineCount
mkdir -p ${SC_outdir}

FA_outdir=/data/joy/BBL/projects/pncControlEnergy/data/matrices/Lausanne125/FA
mkdir -p ${FA_outdir}

volNorm_outdir=/data/joy/BBL/projects/pncControlEnergy/data/matrices/Lausanne125/volNormSC
