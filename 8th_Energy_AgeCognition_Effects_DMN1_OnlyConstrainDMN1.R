...
Energy_Mat_Path = paste0(ReplicationFolder, '/data/energyData/InitialAll0_TargetDMN1_OnlyConstrainDM.mat');
Energy_Mat = readMat(Energy_Mat_Path);
Energy <- Energy_Mat$Energy;
Energy_YeoAvg <- Energy_Mat$Energy.YeoAvg;

ResultantFolder <- paste0(ReplicationFolder, '/results/InitialAll0_TargetDMN1_OnlyConstrainDM');
