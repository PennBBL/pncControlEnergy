...
for (i in c(1:100))
{
  Energy_Mat_Path <- paste0(Energy_Data_Folder, '/FA_Energy/FA_InitialAll0_TargetActivationMean_NullNetwork_', as.character(i), '.mat');
  ...
  Energy_Gam_Cognition_CSV <- file.path(ResultantFolder, paste0('Energy_Gam_Cognition_YeoSystemLevel_NullNetwork_', as.character(i), '.mat'));
