...
ResultantFolder <- paste0(ReplicationFolder, '/results/FA_Energy/InitialAll0_TargetMeanActivation_EnergyDivideActivation');
...
for (i in c(1:100))
{
  Energy_Mat_Path <- paste0(Energy_Data_Folder, '/FA_Energy/FA_InitialAll0_TargetActivationMeanRandom_', as.character(i), '.mat');
  ...
  Energy_Gam_Cognition_CSV <- file.path(ResultantFolder, paste0('Energy_Gam_Cognition_YeoSystemLevel_ShuffledTarget_', as.character(i), '.mat'));
  write.csv(Energy_Gam_Cognition_CSV, Energy_Gam_Cognition_CSV);
  Energy_Gam_Cognition_Mat <- file.path(ResultantFolder, paste0('Energy_Gam_Cognition_YeoSystemLevel_ShuffledTarget_', as.character(i), '.mat'));
