...
writeMat("/data/jux/BBL/projects/pncControlEnergy/results/Replication/data/Activation_677_Avg.mat", Activation_677_Avg = Activation_677_Avg, Activation_677 = Activation_2b0b_Extract, scan_ID_Activation = scan_ID_Activation);
...
# Bifactor score
Bifactor_Data <- read.csv("/data/joy/BBL/studies/pnc/n1601_dataFreeze/clinical/n1601_goassess_itemwise_bifactor_scores_20161219.csv");
# Corrtraite 
Corrtraite_Data <- read.csv("/data/joy/BBL/studies/pnc/n1601_dataFreeze/clinical/n1601_goassess_itemwise_corrtraits_scores_20161219.csv");
# Merge all data
...
demo <- merge(demo, Corrtraite_Data, by = c("scanid", "bblid"));
# Output the subjects' behavior data
dir.create("/data/jux/BBL/projects/pncControlEnergy/results/Replication/data/BehaviorData/");
write.csv(demo, "/data/jux/BBL/projects/pncControlEnergy/results/Replication/data/BehaviorData/n949_Behavior_20180522.csv", row.names = FALSE);
