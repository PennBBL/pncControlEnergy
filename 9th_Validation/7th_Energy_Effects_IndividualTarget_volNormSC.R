...
##########             Validation results: volNormSC network            ##########
##################################################################################
...
#F2SocialCogAccuracy
print('###### F2SocialCogAccuracy effect of energy at Yeo system level (volNormSC matrix) ######');
Energy_Gam_Cognition_YeoAvg <- matrix(c(1:SystemsQuantity*3), nrow = SystemsQuantity, ncol = 3, dimnames = list(RowName_Yeo, ColName));
for (i in 1:SystemsQuantity)
{
  tmp_variable <- Energy_YeoAvg[, i];
...
# F3MemoryAccuracy
print('###### F3MemoryAccuracy effect of energy at Yeo system level (volNormSC matrix) ######');
Energy_Gam_Cognition_YeoAvg <- matrix(c(1:SystemsQuantity*3), nrow = SystemsQuantity, ncol = 3, dimnames = list(RowName_Yeo, ColName));
for (i in 1:SystemsQuantity)
{
  tmp_variable <- Energy_YeoAvg[, i];
