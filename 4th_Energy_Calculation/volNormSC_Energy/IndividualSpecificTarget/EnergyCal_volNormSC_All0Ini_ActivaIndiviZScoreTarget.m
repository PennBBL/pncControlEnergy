...
EnergyCal_IndividualTarget_SGE_Function(Lausanne125_volNormSC_Matrix_Cell(Include_Index), T, xc, x0, xf_Cell, rho, Type, ResultantFolder);
...
save([volNormSC_ResultantFolder '/volNormSC_InitialAll0_TargetIndividualActivationZScore.mat'], 'Distance', 'Distance_sum', '-append');
