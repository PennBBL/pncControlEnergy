...
for i = 1:length(T)
    ...
    ResultantFolder = [SC_ResultantFolder '/InitialAll0_TargetActivation_T_' T_Str];
    EnergyCal_SGE_Function(Lausanne125_SC_Matrix_Cell, T(i), xc, x0, xf, rho, Type, ResultantFolder);
end
