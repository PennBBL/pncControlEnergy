...
Atlas_Yeo_Index = Atlas_Yeo_Index([1:191 193:233]); % Remove the 192th region and brain stem (the 234th region)
...
ResultantFolder = [EnergyFolder '/InitialAll0_TargetMotor1_OnlyConstrainMotor'];
...
EnergyMat_Path = [EnergyFolder '/InitialAll0_TargetMotor1_OnlyConstrainMotor.mat'];
