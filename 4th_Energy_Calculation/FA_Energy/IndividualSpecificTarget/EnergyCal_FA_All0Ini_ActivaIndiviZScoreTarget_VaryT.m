...
for i = 1:length(T)
    ...
    EnergyCal_IndividualTarget_SGE_Function(Lausanne125_FA_Matrix_Cell(Include_Index), T(i), xc, x0, xf_Cell, rho, Type, ResultantFolder);
end
...
for i = 1:length(T)
  ...
  save([FA_ResultantFolder '/FA_InitialAll0_TargetIndividualActivationZScore_T_' T_Str '.mat'], 'Distance', 'Distance_sum', '-append');
end
