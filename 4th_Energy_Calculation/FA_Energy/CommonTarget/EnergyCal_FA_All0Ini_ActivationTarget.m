...
Type = 'FA';
ResultantFolder = [FA_ResultantFolder '/InitialAll0_TargetActivation'];
...
EnergyMat_Path = [FA_ResultantFolder '/FA_InitialAll0_TargetActivation.mat'];
...
save([FA_ResultantFolder '/FA_InitialAll0_TargetActivation.mat'], 'Distance', 'Distance_sum', '-append');
