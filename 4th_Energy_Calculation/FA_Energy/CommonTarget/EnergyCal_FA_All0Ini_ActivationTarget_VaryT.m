...
for i = 1:length(T)
  ...
  ResultantFolder = [FA_ResultantFolder '/InitialAll0_TargetActivation_T_' T_Str];
...
for i = 1:length(T)
  T_Str = strrep(num2str(T(i)), '.', '');
  EnergyMat_Path = [FA_ResultantFolder '/FA_InitialAll0_TargetActivation_T_' T_Str '.mat'];
...
for i = 1:length(T)
  ...
  save([FA_ResultantFolder '/FA_InitialAll0_TargetActivation_T_' T_Str '.mat'], 'Distance', 'Distance_sum', '-append');
end
