...
Type = 'FA';
ResultantFolder = [FA_ResultantFolder '/InitialAll0_TargetFP1'];
...
EnergyMat_Path = [FA_ResultantFolder '/FA_InitialAll0_TargetFP1.mat'];
...
save([FA_ResultantFolder '/FA_InitialAll0_TargetFP1.mat'], 'Distance', 'Distance_sum', '-append');
