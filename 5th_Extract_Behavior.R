...
#3. Extract Behavioral data according to order of the matrices
...
write.csv(demo, "/data/jux/BBL/projects/pncControlEnergy/results/Replication/data/BehaviorData/n803_Behavior_20180321.csv", row.names = FALSE);
