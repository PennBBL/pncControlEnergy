...
print(paste0('P value of the relationship between energy of subcortical system and social cognition was ', as.character(P_SocialCognition)));
# Memory accuracy
...
print(paste0('P value of the relationship between energy of subcortical system and memory was ', as.character(P_Memory)));
