...
x0 = zeros(n, 1);
ResultantFolder_1 = [SC_ResultantFolder '/InitialAll0_TargetFP1DMN1'];
...
x0(find(x0 == 7)) = 1;
x0(find(x0 == 6)) = 0;
ResultantFolder_2 = [SC_ResultantFolder '/InitialDM1_TargetFP1DMN1'];
...
x0(find(x0 == 7)) = 1;
x0(find(x0 == 6)) = -1;
ResultantFolder_3 = [SC_ResultantFolder '/InitialDM1FPN1_TargetFP1DMN1'];
EnergyCal_SGE_Function(Lausanne125_SC_Matrix_Cell, scale_factor, T, xc, x0, xf, rho, Type, ResultantFolder_3);
