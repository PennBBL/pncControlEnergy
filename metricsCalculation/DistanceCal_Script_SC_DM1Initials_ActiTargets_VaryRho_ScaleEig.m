...
for i = 5:length(rho)
  ...
  Energy_Cell = g_ls([EnergyData_Folder '/InitialDM1_TargetActivation_rho_' rho_Str '/*.mat']);
  ...
  save([EnergyData_Folder '/SC_InitialDM1_TargetActivation_rho_' rho_Str '.mat'], 'Distance', 'Distance_sum', '-append');
end
