...
for i = 1:length(rho)
    ...
    ResultantFolder = [SC_ResultantFolder '/InitialDM1_TargetActivation_rho_' rho_Str];
    EnergyCal_SGE_Function(Lausanne125_SC_Matrix_Cell, scale_factor, T, xc, x0, xf, rho(i), Type, ResultantFolder);
end
