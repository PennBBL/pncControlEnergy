...
% Energy map (Initial: DM 1; Target: Activation of each individual)
...
SC_InitialDM1_TargetIndividualActivation = load([EnergyFolder '/SC_Energy/SC_InitialDM1_TargetIndividualActivation.mat']);
Energy_SubjectsAvg = mean(SC_InitialDM1_TargetIndividualActivation.Energy)';
Energy_SC_InitialDM1_TargetIndividualActivation = Atlas_data;
for i = 1:233
  Energy_SC_InitialDM1_TargetIndividualActivation(find(Energy_SC_InitialDM1_TargetIndividualActivation == i)) = Energy_SubjectsAvg(i);
end
hdr.fname = [ResultantFolder '/SC_InitialDM1_TargetIndividualActivation.nii'];
hdr.dt = [16 0];
spm_write_vol(hdr, Energy_SC_InitialDM1_TargetIndividualActivation);
Energy_YeoAvg_SubjectsAvg = mean(SC_InitialDM1_TargetIndividualActivation.Energy_YeoAvg)';
save([EnergyFolder '/SC_Energy/SC_InitialDM1_TargetIndividualActivation.mat'], 'Energy_SubjectsAvg', 'Energy_YeoAvg_SubjectsAvg', '-append');
