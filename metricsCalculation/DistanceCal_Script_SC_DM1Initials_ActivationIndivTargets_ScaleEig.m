...
Energy_Cell = g_ls([EnergyData_Folder '/InitialDM1_TargetIndivActivation_ScaleEig/*.mat']);
...
save([EnergyData_Folder '/SC_InitialDM1_TargetIndivActivation_ScaleEig.mat'], 'Distance', 'Distance_sum', '-append');
