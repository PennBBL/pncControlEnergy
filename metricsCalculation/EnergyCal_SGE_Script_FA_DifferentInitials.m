...
x0 = zeros(n, 1);
ResultantFolder_1 = [FA_ResultantFolder '/Initial_AllZeros'];
EnergyCal_SGE_Function(Lausanne125_FA_Matrix_Cell, scale_factor, T, xc, x0, xf, rho, Type, ResultantFolder_1);

% 2st initial state: DM 1, others 0
x0 = Yeo_Index;
x0(find(x0 == 7)) = 1;
x0(find(x0 == 6)) = 0;
ResultantFolder_2 = [FA_ResultantFolder '/Initial_DM'];
EnergyCal_SGE_Function(Lausanne125_FA_Matrix_Cell, scale_factor, T, xc, x0, xf, rho, Type, ResultantFolder_2);

% 3rd initial state: DM 1, FP -1, others 0
x0 = Yeo_Index;
x0(find(x0 == 7)) = 1;
x0(find(x0 == 6)) = -1;
ResultantFolder_3 = [FA_ResultantFolder '/Initial_DM1FPSuppress'];
EnergyCal_SGE_Function(Lausanne125_FA_Matrix_Cell, scale_factor, T, xc, x0, xf, rho, Type, ResultantFolder_3);
