...
nbackRelMeanRMSMotion = tmp$nbackRelMeanRMSMotion[Indice];
...
nbackBehTwobackDprime = tmp$nbackBehTwobackDprime[Indice];

Resultant_Mat = "/data/joy/BBL/projects/pncControlEnergy/data/subjectData/nback_2b0b_20170427_Eli.mat";
writeMat(Resultant_Mat, Scan_ID_SC = t(Scan_ID_SC), Activation_2b0b = Activation_2b0b, nbackExclude = nbackExclude, nbackZerobackExclude = nbackZerobackExclude, nbackRelMeanRMSMotion = nbackRelMeanRMSMotion, nbackBehTwobackDprime = nbackBehTwobackDprime);
