...
Resultant_Mat = "/data/joy/BBL/projects/pncControlEnergy/data/subjectData/n949_Demogra_DtiMotion.mat";
...
Resultant_CSV = "/data/joy/BBL/projects/pncControlEnergy/data/subjectData/n949_Demogra_DtiMotion.csv";
