...
health <- read.csv("/data/jux/BBL/projects/pncControlEnergy/data/subjectData/n1601_health_20170421.csv")
## T1
t1_qa <- read.csv("/data/jux/BBL/projects/pncControlEnergy/data/subjectData/n1601_t1QaData_20170306.csv")
## DTI 
dti_qa <- read.csv("/data/jux/BBL/projects/pncControlEnergy/data/subjectData/n1601_dti_qa_20170301.csv")
## B0 Acquisition
protVal <- read.csv("/data/jux/BBL/projects/pncControlEnergy/data/subjectData/n1601_pnc_protocol_validation_params_status_20161220.csv")
## Demographics
demo <- read.csv("/data/jux/BBL/projects/pncControlEnergy/data/subjectData/n1601_demographics_go1_20161212.csv")
## Clinical Scores
clin_bifactor <- read.csv("/data/jux/BBL/projects/pncControlEnergy/data/subjectData/n1601_goassess_itemwise_bifactor_scores_20161219.csv")
clin_corrtraits <- read.csv("/data/jux/BBL/projects/pncControlEnergy/data/subjectData/n1601_goassess_itemwise_corrtraits_scores_20161219.csv")
clin_fscores <- read.csv("/data/jux/BBL/projects/pncControlEnergy/data/subjectData/n1601_goassess_itemwise_fscores_self_regressed_20170131.csv")
## Subject identifier
tracker <- read.csv("/data/jux/BBL/projects/pncControlEnergy/data/subjectData/n1601_tracker_go1_20161212.csv")
...
write.csv(subjid_df, "/data/jux/BBL/projects/pncControlEnergy/subjectLists/pncControlEnergy_n949_subjectIDs.csv", row.names=FALSE)

## Write out all demographics and QA data to CSV
write.csv(ControlEnergy_df, "/data/jux/BBL/projects/pncControlEnergy/subjectLists/pncControlEnergy_n949_subject_data.csv", row.names=FALSE)
