...
for (i in c(1:8))
{
  ...
  Energy_Gam_Cognition_CSV <- file.path(ResultantFolder, paste0('Energy_Gam_nbackBehAllDprime_YeoSystemLevel_T_', Para_Str, '.csv'));
  write.csv(Energy_Gam_Cognition_YeoAvg, Energy_Gam_Cognition_CSV);
  Energy_Gam_Cognition_Mat <- file.path(ResultantFolder, paste0('Energy_Gam_nbackBehAllDprime_YeoSystemLevel_T_', Para_Str, '.mat'));
...
for (i in c(1:8))
{
  ...
  Energy_Gam_Cognition_YeoAvg[, 3] <- p.adjust(Energy_Gam_Cognition_YeoAvg[, 2], "fdr");
  Energy_Gam_Cognition_CSV <- file.path(ResultantFolder, paste0('Energy_Gam_nbackBehAllDprime_YeoSystemLevel_rho_', Para_Str, '.csv'));
  write.csv(Energy_Gam_Cognition_YeoAvg, Energy_Gam_Cognition_CSV);
  Energy_Gam_Cognition_Mat <- file.path(ResultantFolder, paste0('Energy_Gam_nbackBehAllDprime_YeoSystemLevel_rho_', Para_Str, '.mat'));
  writeMat(Energy_Gam_Cognition_Mat, Cognition_Z = Energy_Gam_Cognition_YeoAvg[, 1], Cognition_P = Energy_Gam_Cognition_YeoAvg[, 2], Cognition_P_FDR = Energy_Gam_Cognition_YeoAvg[, 3]);
  print(Energy_Gam_Cognition_YeoAvg)
} 
