...
def ElasticNet_APredictB(Training_Data, Training_Score, Testing_Data, Testing_Score, AlphaRange, L1_ratio_Range, Nested_Fold_Quantity, ResultantFolder, Parallel_Quantity, Permutation_Flag):
    ...
    # Model_result = {'Weight': clf.coef_, 'Intercept': clf.intercept_}
    # sio.savemat(ResultantFolder+'/Model.mat', Model_result);
    externals.joblib.dump(Scale, ResultantFolder+'/Scale.pkl')
    externals.joblib.dump(clf, ResultantFolder+'/Model.pkl')
