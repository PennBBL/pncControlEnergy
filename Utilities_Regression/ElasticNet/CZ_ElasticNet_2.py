...
def ElasticNet_KFold_Permutation(Subjects_Data, Subjects_Score, Times_IDRange, l1_ratio, Fold_Quantity, InnerCV_Flag, ResultantFolder, Parallel_Quantity, Max_Queued, Queue):
    ...
    for i in np.arange(len(Times_IDRange)):
        ...
        if not os.path.exists(ResultantFolder_I + '/Res_NFold.mat'):
            ...
            Configuration_Mat = {'Subjects_Data_Mat_Path': Subjects_Data_Mat_Path, 'Subjects_Score': Subjects_Score, 'l1_ratio': l1_ratio, \
            ...
            system_cmd = 'python3 -c ' + '\'import sys;\
                ...
                from ElasticNet_CZ import ElasticNet_KFold_Permutation_Sub;\
                import os;\
                import scipy.io as sio;\
                ...
                ElasticNet_KFold_Permutation_Sub(Subjects_Data_Mat_Path[0], Subjects_Score[0], l1_ratio[0][0], Fold_Quantity[0][0], InnerCV_Flag[0][0], ResultantFolder_I[0], Parallel_Quantity[0][0])\' ';
...
def ElasticNet_KFold_Permutation_Sub(Subjects_Data_Mat_Path, Subjects_Score, l1_ratio, Fold_Quantity, InnerCV_Flag, ResultantFolder, Parallel_Quantity):
    data = sio.loadmat(Subjects_Data_Mat_Path)
    Subjects_Data = data['Subjects_Data']
    ElasticNet_KFold(Subjects_Data, Subjects_Score, l1_ratio, Fold_Quantity, InnerCV_Flag, ResultantFolder, Parallel_Quantity, 1);
   
def ElasticNet_KFold(Subjects_Data, Subjects_Score, l1_ratio, Fold_Quantity, InnerCV_Flag, ResultantFolder, Parallel_Quantity, Permutation_Flag):
