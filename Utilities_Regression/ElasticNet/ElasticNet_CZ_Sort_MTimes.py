        ...
        for j in np.arange(Times_SampleResample):
            if not os.path.exists(ResultantFolder_I + '/Prediction_' + str(j) + '.mat'):
                ...
                system_cmd = 'python3 -c ' + '\'import sys;\
                    ...
                    from ElasticNet_CZ_Sort_MTimes import ElasticNet_KFold_Sort_OneSubset;\
                    import os;\
                    import scipy.io as sio;\
...
def ElasticNet_KFold_Sort_OneSubset(Subjects_Data_Mat_Path, Subjects_Score, SelectedIDs, SampleIndex, Fold_Quantity, Alpha_Range, L1_ratio_Range, ResultantFolder, Parallel_Quantity):
    ...
    Mean_Corr, Mean_MAE = ElasticNet_KFold_Sort(Data_Selected, Scores_Selected, Fold_Quantity, Alpha_Range, L1_ratio_Range, ResultantFolder_I, Parallel_Quantity)
...
def ElasticNet_KFold_Sort(Subjects_Data, Subjects_Score, Fold_Quantity, Alpha_Range, L1_ratio_Range, ResultantFolder, Parallel_Quantity):
