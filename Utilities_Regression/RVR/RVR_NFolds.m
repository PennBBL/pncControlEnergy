function Prediction = RVR_NFolds(Subjects_Data, Subjects_Scores, Covariates, FoldQuantity, Pre_Method, Weight_Flag, RandID, Permutation_Flag, ResultantFolder)
%
% Subject_Data:
%           m*n matrix
...
for j = 1:FoldQuantity
    ...
    if Permutation_Flag
        PermutationIndex = randperm(length(Training_scores));
        Training_scores = Training_scores(PermutationIndex);
    end
