...
def LinearRegression_KFold_Sort_AllSubsets(Subjects_Data_Mat_Path, Subjects_Score, SampleSize_Array, Times_SampleResample, Fold_Quantity, ResultantFolder, Max_Queued, QueueOptions):
        ...
        for j in np.arange(Times_SampleResample):
            if not os.path.exists(ResultantFolder_I + '/Prediction_' + str(j) + '.mat'):
                ...
                system_cmd = 'python3 -c ' + '\'import sys;\
                    ...
                    LinearRegression_KFold_Sort_OneSubset(Subjects_Data_Mat_Path[0], Subjects_Score[0], SampleSize[0][0], Fold_Quantity[0][0], Sample_Index[0][0], ResultantFolder_I[0])\' ';
...
def LinearRegression_KFold_Sort_OneSubset(Subjects_Data_Mat_Path, Subjects_Score, SampleSize, Fold_Quantity, SampleIndex, ResultantFolder):
    ...
    Mean_Corr, Mean_MAE = LinearRegression_KFold_Sort(Data_Selected, Scores_Selected, Fold_Quantity)
