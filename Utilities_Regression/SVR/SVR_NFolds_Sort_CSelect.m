function Prediction = SVR_NFolds_Sort_CSelect(Subjects_Data, Subjects_Scores, Covariates, FoldQuantity, Pre_Method, C_Range, Weight_Flag, ResultantFolder)
%
% Subject_Data:
%           m*n matrix
...
for j = 1:FoldQuantity
    ...
    for m = 1:length(C_Range)
        Prediction_Inner = SVR_NFolds_Sort(Training_data, Training_scores, [], 5, Pre_Method, C_Range(m));
