...
ResultantFolder = ReplicationFolder + '/results/Age_Prediction_SmallerThanNull/2Fold_Random';
Ridge_CZ_Random.Ridge_KFold_RandomCV_MultiTimes(Energy, Age, FoldQuantity, Alpha_Range, 20, ResultantFolder, 1, 0);
