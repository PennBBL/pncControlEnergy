...
AgePrediction_ResFolder = [ReplicationFolder '/results/Age_Prediction_SmallerThanNull/2Fold_Sort'];
...
%% Significance
AgePrediction_PermutationFolder = [ReplicationFolder '/results/Age_Prediction_SmallerThanNull/2Fold_Sort_Permutation'];
% Fold 0
...
save([ReplicationFolder '/results/Age_Prediction_SmallerThanNull/2Fold_Sort_Fold0_Sig.mat'], 'Corr_Actual_Fold0', 'MAE_Actual_Fold0', 'Corr_Rand_Fold0', 'MAE_Rand_Fold0', 'Corr_Fold0_Sig', 'MAE_Fold0_Sig');
% Fold 1
...
save([ReplicationFolder '/results/Age_Prediction_SmallerThanNull/2Fold_Sort_Fold1_Sig.mat'], 'Corr_Actual_Fold1', 'MAE_Actual_Fold1', 'Corr_Rand_Fold1', 'MAE_Rand_Fold1', 'Corr_Fold1_Sig', 'MAE_Fold1_Sig');

%% Specificity
Behavior = load([ReplicationFolder '/data/Age_Prediction_SmallerThanNull/Energy_Behavior_AllSubjects.mat']);
% Fold 0
