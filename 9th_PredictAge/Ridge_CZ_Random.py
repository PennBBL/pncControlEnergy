...
def Ridge_KFold_RandomCV_MultiTimes(Subjects_Data, Subjects_Score, Covariates, Fold_Quantity, Alpha_Range, CVRepeatTimes, ResultantFolder, Parallel_Quantity, Permutation_Flag):
    ...
    for i in np.arange(CVRepeatTimes):
        ...
        Corr_I, MAE_I = Ridge_KFold_RandomCV(Subjects_Data, Subjects_Score, Covariates, Fold_Quantity, Alpha_Range, CVRepeatTimes, ResultantFolder_TimeI, Parallel_Quantity, Permutation_Flag);
