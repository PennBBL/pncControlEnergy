...
Index <- readMat(paste0(ReplicationDataFolder, '/SmallerThanNull_Index.mat'));
...
dir.create(paste0(ReplicationDataFolder, '/Age_Prediction_SmallerThanNull'));
writeMat(paste0(ReplicationDataFolder, '/Age_Prediction_SmallerThanNull/Energy_Behavior_AllSubjects.mat'), Energy = Energy, Age = Age, Sex = Sex, HandednessV2 = HandednessV2, MotionMeanRelRMS = MotionMeanRelRMS, TBV = TBV, Strength_EigNorm_SubIden = Strength_EigNorm_SubIden, ScanID = ScanID);
