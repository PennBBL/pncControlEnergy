...
ReplicationDataFolder = '/data/jux/BBL/projects/pncControlEnergy/results/Replication_Prob/data';
...
AllInfo <- read.csv(paste0(ReplicationDataFolder, '/n946_Behavior_20180712.csv'));
