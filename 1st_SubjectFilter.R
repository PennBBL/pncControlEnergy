...
dir.create("/data/jux/BBL/projects/pncControlEnergy/results/Replication_Prob/data");
write.csv(subjid_df, "/data/jux/BBL/projects/pncControlEnergy/results/Replication_Prob/data/pncControlEnergy_n946_SubjectsIDs.csv", row.names=FALSE)
